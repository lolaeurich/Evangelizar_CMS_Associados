...
function Velas() {
    ...
    const [dadosVelas, setDadosVelas] = useState([]);

    // Simula a busca inicial dos dados na API
    useEffect(() => {
        async function fetchDadosVelas() {
            try {
    ...
    const dadosFiltrados = applyFilters(dadosVelas, filtros);
            ...
            <div className="velas-container">
                ...
                <div className="container-de-graficos">
                    ...
                    <div className="velas-grafico-pizza">
                        <div className="filtro-grafico-pizza">
                            <div className="filtros-velas">
                                <div className='filtros'>
                                    <h2 className='velas-h2'>Status de Velas</h2>
                                    <input
                        ...
                        <ChartComponent data={dadosFiltrados} />
                    </div>
