...
export const TestemunhosContext = createContext({
  testemunhos: [],
  setTestemunho: () => {}, // Incluindo setVelas no contexto
  inserirTestemunho: () => {},
  editarTestemunho: () => {},
  excluirTestemunho: () => {},
});
...
export const TestemunhosProvider = ({ children }) => {
  ...
  const fetchTestemunhos = async () => {
    try {
      ...
      console.error("Erro ao buscar dados de testemunho:", error);
    }
  };
  ...
  const value = {
    testemunhos,
    setTestemunhos, // Incluindo setVelas no objeto de valor do contexto
    inserirTestemunho,
    editarTestemunho,
    excluirTestemunho,
  };
